...
esttab polesw2 turksw2 using "${WD}/figures_tables/SI Appendix Table 16_participationw2.xls", delimiter(;) ///
...
graph export "${WD}/figures_tables/SI Appendix Fig S 3.pdf", replace
graph export "${WD}/figures_tables/SI Appendix Fig S 3.svg", replace
graph export "${WD}/figures_tables/SI Appendix Fig S 3.png", replace width(6144) height(3072)
