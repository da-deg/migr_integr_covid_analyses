...
esttab didcontrols1 kmatchmd1 kmatchps1 fe1 using "${OUTPUT}/SI Appendix Table S`j' figure03_`panel'_table_poles_`label'.xls", delimiter(;) ///
...
esttab didcontrols2 kmatchmd2 kmatchps2 fe2 using "${OUTPUT}/SI Appendix Table S`j' figure04_`panel'_table_turks_`label'.xls", delimiter(;) ///
